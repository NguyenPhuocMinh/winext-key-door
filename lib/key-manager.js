...
function KeyManager(params = {}) {
  ...
  this.middleware = function (opts = {}) {
    try {
      ...
      middlewares.push(Init.config(opts));
      middlewares.push(Init.postAdmin(opts));
      middlewares.push(Admin.login(opts));
      middlewares.push(Admin.logout(opts));
